...
public class Display extends JComponent implements KeyListener, MouseListener
{
  ...
  private int mouseY;
  private World world;
  private ConcurrentLinkedQueue<KeyEvent> keys;
  private MobileSprite movingSquare;
  private String soundtrack = "Cool-Adventure-Intro.wav";
    
  public Display(final int width, final int height, final double speed)
  {
    ...
    try
    {
      SwingUtilities.invokeAndWait(new Runnable() { public void run() {
        world = new World(width, height, speed);
